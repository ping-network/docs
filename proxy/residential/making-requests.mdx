...
```
curl -x proxy.pingnetwork.io:7777 -U "USERNAME:PASSWORD" https://ipecho.net/plain
```
...
```
curl -x proxy.pingnetwork.io:7777 -U "USERNAME-cc-GB:PASSWORD" https://ipecho.net/plain
```
