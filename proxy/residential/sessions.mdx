...
- Also a unique alphanumeric string, 6 to 15 characters long.
...
- If not specified, the session will last for 20 minutes by default.
...
<Tabs>
  <Tab title="CURL">
    curl -x http://USERNAME-sid-abc123:PASSWORD@proxy.pingnetwork.io:7776 http://ipecho.net/plain
  </Tab>
  <Tab title="Python">
